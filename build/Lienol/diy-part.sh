...
export Op_name="OpenWrt-Feng"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 旁路由选项
export Gateway_Settings="192.168.8.3"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
export DNS_Settings="192.168.8.3"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
